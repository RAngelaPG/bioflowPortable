...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="staApp_1-out204fb4ac5ffadd55" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="staApp_1-traitSta" class="shiny-input-select"><option value="GERMPCT" selected>GERMPCT</option>
<option value="PH">PH</option>
<option value="DAYSFL">DAYSFL</option>
<option value="DAYSMT">DAYSMT</option>
<option value="GY_CALC_THA">GY_CALC_THA</option></select>
<script type="application/json" data-for="staApp_1-traitSta" data-nonempty="">{"plugins":["selectize-plugin-a11y"]}</script>
</div>
</div><!--/html_preserve-->

<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="staApp_1-out66d0e0a98b6000e6" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="staApp_1-traitStaFieldView" class="shiny-input-select"><option value="GERMPCT" selected>GERMPCT</option>
<option value="PH">PH</option>
<option value="DAYSMT">DAYSMT</option>
<option value="GY_CALC_THA">GY_CALC_THA</option>
<option value="DAYSFL">DAYSFL</option></select>
<script type="application/json" data-for="staApp_1-traitStaFieldView" data-nonempty="">{"plugins":["selectize-plugin-a11y"]}</script>
</div>
</div><!--/html_preserve-->

<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-out22de584e43692ace" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div>
<select id="staApp_1-traitSta0" class="shiny-input-select"><option value="GERMPCT" selected>GERMPCT</option>
<option value="PH">PH</option>
<option value="DAYSFL">DAYSFL</option>
<option value="DAYSMT">DAYSMT</option>
<option value="GY_CALC_THA">GY_CALC_THA</option></select>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-outb30072cae37ee56d" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-out86ac445bd4518d3a" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="staApp_1-out01930d74fe2c5ceb" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="staApp_1-envSta" class="shiny-input-select"><option value="BISA Jabalpur_TPE1_SA_24B-011" selected>BISA Jabalpur_TPE1_SA_24B-011</option>
<option value="BISA Pusa_TPE3_SA_24B-008">BISA Pusa_TPE3_SA_24B-008</option>
<option value="BISA Pusa_TPE1_SA_24B-010">BISA Pusa_TPE1_SA_24B-010</option>
<option value="BISA Jabalpur_TPE3_SA_24B-009">BISA Jabalpur_TPE3_SA_24B-009</option>
<option value="BISA Pusa_TPE2_SA_24B-009">BISA Pusa_TPE2_SA_24B-009</option>
<option value="BISA Jabalpur_TPE2_SA_24B-010">BISA Jabalpur_TPE2_SA_24B-010</option>
<option value="BISA Ladhowal_TPE3_SA_24B-007">BISA Ladhowal_TPE3_SA_24B-007</option>
<option value="BISA Ladhowal_TPE1_SA_24B-009">BISA Ladhowal_TPE1_SA_24B-009</option>
<option value="BISA Ladhowal_TPE2_SA_24B-008">BISA Ladhowal_TPE2_SA_24B-008</option></select>
<script type="application/json" data-for="staApp_1-envSta" data-nonempty="">{"plugins":["selectize-plugin-a11y"]}</script>
</div>
</div><!--/html_preserve-->

<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="staApp_1-out8f5cedb28de99157" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="staApp_1-traitStaBox" class="shiny-input-select"><option value="GERMPCT" selected>GERMPCT</option>
<option value="PH" selected>PH</option>
<option value="DAYSFL" selected>DAYSFL</option>
<option value="DAYSMT" selected>DAYSMT</option>
<option value="GY_CALC_THA" selected>GY_CALC_THA</option></select>
<script type="application/json" data-for="staApp_1-traitStaBox" data-nonempty="">{"plugins":["selectize-plugin-a11y"]}</script>
</div>
</div><!--/html_preserve-->

<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-outd13d4b525f76e8b1" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div>
<select id="staApp_1-traitStaComp" class="shiny-input-select"><option value="GERMPCT" selected>GERMPCT</option>
<option value="PH">PH</option>
<option value="DAYSFL">DAYSFL</option>
<option value="DAYSMT">DAYSMT</option>
<option value="GY_CALC_THA">GY_CALC_THA</option></select>
...
<div>
<select id="staApp_1-traitStaCompEnv" class="shiny-input-select"><option value="BISA Jabalpur_TPE1_SA_24B-011" selected>BISA Jabalpur_TPE1_SA_24B-011</option>
<option value="BISA Jabalpur_TPE2_SA_24B-010">BISA Jabalpur_TPE2_SA_24B-010</option>
<option value="BISA Jabalpur_TPE3_SA_24B-009">BISA Jabalpur_TPE3_SA_24B-009</option>
<option value="BISA Ladhowal_TPE1_SA_24B-009">BISA Ladhowal_TPE1_SA_24B-009</option>
<option value="BISA Ladhowal_TPE2_SA_24B-008">BISA Ladhowal_TPE2_SA_24B-008</option>
<option value="BISA Ladhowal_TPE3_SA_24B-007">BISA Ladhowal_TPE3_SA_24B-007</option>
<option value="BISA Pusa_TPE1_SA_24B-010">BISA Pusa_TPE1_SA_24B-010</option>
<option value="BISA Pusa_TPE2_SA_24B-009">BISA Pusa_TPE2_SA_24B-009</option>
<option value="BISA Pusa_TPE3_SA_24B-008">BISA Pusa_TPE3_SA_24B-008</option></select>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-out5e76d0991f5ce1a4" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div>
<select id="staApp_1-traitStaCor" class="shiny-input-select"><option value="GERMPCT" selected>GERMPCT</option>
<option value="PH" selected>PH</option>
<option value="DAYSFL" selected>DAYSFL</option>
<option value="DAYSMT" selected>DAYSMT</option>
<option value="GY_CALC_THA" selected>GY_CALC_THA</option></select>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-outca6d9b4d700c347d" style="width:100%;height:400px;"></div><!--/html_preserve-->
