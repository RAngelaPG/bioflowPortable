...
<div>
<select id="qaPhenoApp_1-traitQa" class="shiny-input-select"><option value="GERMPCT" selected>GERMPCT</option>
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="qaPhenoApp_1-out33d9db7901bc5b1c" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="qaPhenoApp_1-traitQaBox" class="shiny-input-select"><option value="GERMPCT" selected>GERMPCT</option>
<option value="PH">PH</option>
<option value="DAYSFL">DAYSFL</option>
<option value="DAYSMT">DAYSMT</option>
<option value="GY_CALC_THA">GY_CALC_THA</option></select>
...
<!--html_preserve--><div class="shiny-plot-output html-fill-item" id="qaPhenoApp_1-out663dd6c223ce7af3" style="width:100%;height:400px;"></div><!--/html_preserve-->
